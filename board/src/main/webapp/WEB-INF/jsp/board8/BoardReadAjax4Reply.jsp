...
<div id="replyItem<c:out value="${replyInfo.reno}"/>" 
	...
	<a href="board8ReplyDelete?reno=<c:out value="${replyInfo.reno}"/>" onclick="fn_replyDelete('<c:out value="${replyInfo.reno}"/>')">삭제</a>
	<a href="board8ReplyDelete" onclick="fn_replyUpdate('<c:out value="${replyInfo.reno}"/>')">수정</a>
	<a href="board8ReplyDelete" onclick="fn_replyReply('<c:out value="${replyInfo.reno}"/>')">댓글</a>
	<br/>
