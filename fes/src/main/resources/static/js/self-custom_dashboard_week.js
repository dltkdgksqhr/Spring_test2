...
//차트 데이터 셋
weekDataInit();
function weekDataInit(){
//    초기화
    _weekLength = $('#week_data_length').val(); // 데이터 길이
    _weekLocalDateArr = []; // 주간 날짜
    _weekMdnIncArr = []; // 누적 모돈 수 배열
...
//차트 구현부
weekMdnChartDraw(); //일간 누적 모돈 수 차트 구현
weekEkpChartDraw(); //일간 누적 출하두 수 차트 구현
weekTtlChartDraw(); //일간 누적 데이터 건 수 차트 구현

//주간 누적 모돈 수 차트 구현
function weekMdnChartDraw(){
