...
//차트 데이터 셋
dailyDataInit();
function dailyDataInit(){
    //초기화
    _dailyLength = $('#daily_data_length').val(); // 데이터 길이
    _dailyMdnIncAvg, _dailyEkpIncAvg, _dailyTtlIncAvg; // 증감 평균값
    _dailyMdnIncAvg = _dailyEkpIncAvg = _dailyTtlIncAvg = 0;
    _dailyLocalDateArr = []; // 일간 날짜
    _dailyMdnIncArr = []; // 누적 모돈 수 배열
